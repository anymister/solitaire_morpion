            ...
            for j in range(0, n - 3):
                ...
                try:
                    if ((tmp_rep[ind4].get_vertical() == 0) and (tmp_rep[ind1].get_vertical() == 0) and (
                            tmp_rep[ind2].get_vertical() == 0) and (tmp_rep[ind3].get_vertical() == 0) and (tmp_rep[ind].get_vertical() == 0)):
                        if ((tmp_rep[ind4].get_cliqued() == 1) and (tmp_rep[ind1].get_cliqued() == 1) and (
                            ...
                            try:
                                ...
                                LINE = Line(self.rep_cellule.get_rep()[ind], self.rep_cellule.get_rep()[ind1],
                                            self.rep_cellule.get_rep()[ind2], self.rep_cellule.get_rep()[ind3],
                                            self.rep_cellule.get_rep()[ind4])
                                line = LINE.get_line()
                    ...
                    if ((tmp_rep[ind5].get_cliqued() == 1) and (tmp_rep[ind1].get_cliqued() == 1) and (
                        ...
                        try:
                            if tmp_rep[ind].get_vertical() == 0:
                                ...
                                self.rep_cellule.get_rep()[ind2].set_vertical(1)
                                self.rep_cellule.get_rep()[ind3].set_vertical(1)
                                self.rep_cellule.get_rep()[ind5].set_vertical(1)
                                LINE = Line(self.rep_cellule.get_rep()[ind], self.rep_cellule.get_rep()[ind1],
                                            self.rep_cellule.get_rep()[ind2], self.rep_cellule.get_rep()[ind3],
                                            self.rep_cellule.get_rep()[ind5])
                                line = LINE.get_line()
                                self.rep_line.add_line(line)
                    ...
                    if ((tmp_rep[ind5].get_horizontal() == 0) and (tmp_rep[ind1].get_horizontal() == 0) and (
                        ...
                        if ((tmp_rep[ind5].get_cliqued() == 1) and (tmp_rep[ind1].get_cliqued() == 1) and (
                            ...
                            try:
                                ...
                                self.rep_cellule.get_rep()[ind5].set_horizontal(1)
                                LINE = Line(self.rep_cellule.get_rep()[ind], self.rep_cellule.get_rep()[ind1],
                                            self.rep_cellule.get_rep()[ind2], self.rep_cellule.get_rep()[ind3],
                                            self.rep_cellule.get_rep()[ind5])
                                line = LINE.get_line()
                                ...
                                self.add_cels_playable(tmp_rep[ind])
                                print(self.convert_ind_to_ij(ind),"==",self.rep_cellule.get_rep()[ind].get_horizontal(),self.convert_ind_to_ij(ind1),"==",self.rep_cellule.get_rep()[ind1].get_horizontal(),self.convert_ind_to_ij(ind2),"==",self.rep_cellule.get_rep()[ind2].get_horizontal(),self.convert_ind_to_ij(ind3),"==",self.rep_cellule.get_rep()[ind3].get_horizontal(),self.convert_ind_to_ij(ind4),"==",self.rep_cellule.get_rep()[ind4].get_horizontal())
                    ...
                    ((tmp_rep[ind4].get_cliqued() == 1) and (tmp_rep[ind1].get_cliqued() == 1) and (
                        ...
                        try:
                            if self.rep_cellule.get_rep()[ind].get_diagonal_left() == 0:
                                self.rep_cellule.get_rep()[ind].set_cliqued(1)
                                self.rep_cellule.get_rep()[ind].set_diagonal_left(1)
                                self.rep_cellule.get_rep()[ind1].set_diagonal_left(1)
                                self.rep_cellule.get_rep()[ind2].set_diagonal_left(1)
                                self.rep_cellule.get_rep()[ind3].set_diagonal_left(1)
                                self.rep_cellule.get_rep()[ind4].set_horizontal(1)
                                LINE = Line(self.rep_cellule.get_rep()[ind], self.rep_cellule.get_rep()[ind1],
                                            self.rep_cellule.get_rep()[ind2], self.rep_cellule.get_rep()[ind3],
                                            self.rep_cellule.get_rep()[ind4])
                    ...
                    if ((tmp_rep[ind4].get_diagonal_right() == 0) and (tmp_rep[ind1].get_diagonal_right() == 0) and (
                        ...
                        if ((tmp_rep[ind4].get_cliqued() == 1) and (tmp_rep[ind1].get_cliqued() == 1) and (
                            ...
                            if (self.rep_cellule.get_rep()[ind].get_diagonal_right() == 0):
                                ...
                                self.rep_cellule.get_rep()[ind1].set_diagonal_right(1)
                                self.rep_cellule.get_rep()[ind2].set_diagonal_right(1)
                                self.rep_cellule.get_rep()[ind3].set_diagonal_right(1)
                                self.rep_cellule.get_rep()[ind4].set_horizontal(1)
                                LINE = Line(self.rep_cellule.get_rep()[ind], self.rep_cellule.get_rep()[ind1],
                                            self.rep_cellule.get_rep()[ind2], self.rep_cellule.get_rep()[ind3],
                                            self.rep_cellule.get_rep()[ind4])
...
def inventaire(nbr_pos_playable, nbr_cels, nbr_occ_cels, nbr_lines):
    ...
    print("Nombre de coups jouer ----> ", nbr_occ_cels-36)
...
def main():
    ...
    j = 5
    while (j > 0):
        game.get_cels_playable()
        game.console()
        try:
            inventaire(len(game.get_cels_playable()), len(a), len(set(game.get_cels_occuped())), len(game.rep_line.get_rep_line()))
        except Exception as inst:
            print(type(inst))
        j = j - 1
